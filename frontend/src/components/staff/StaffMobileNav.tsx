...
export const StaffMobileNav: React.FC<StaffMobileNavProps> = ({ activeTab, setActiveTab, hasPermission, userRole }) => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-50 flex h-16 items-center justify-around border-t bg-white px-2 sm:px-4 shadow-[0_-1px_3px_rgba(0,0,0,0.1)] md:hidden">
            {/* Quick Access Items */}
            <Button
                variant="ghost"
                size="sm"
